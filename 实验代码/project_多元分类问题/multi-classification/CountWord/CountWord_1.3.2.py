...
# # In [11]:
# file = open('CountWord_submission_1.3.2.csv', 'w')
# for r in res_:
#     file.write(r + '\n')
# file.close()

# # In [12]:
# file = open('CountWord_softprob_1.3.2.csv', 'w')
# for r in res:
#     out = ','.join(map(str,r))
#     file.write(out + '\n')
# file.close()
...
# In [8]:
file = open('CountWord_submission_1.3.3.csv', 'w')
for r in res_:
    file.write(r + '\n')
file.close()

# In [9]:
file = open('CountWord_softprob_1.3.3.csv', 'w')
for r in res:
    out = ','.join(map(str,r))
    file.write(out + '\n')
file.close()
